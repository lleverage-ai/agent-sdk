...
[@lleverage-ai/agent-sdk](../index.md) / SubagentOptions

# Interface: SubagentOptions

Defined in: [packages/agent-sdk/src/types.ts:2285](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/types.ts#L2285)

Configuration for creating a subagent.

## Extends

- `Omit`&lt;[`AgentOptions`](AgentOptions.md), `"model"` \| `"allowedTools"`&gt;
...
Defined in: [packages/agent-sdk/src/types.ts:2347](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/types.ts#L2347)
...
[`AgentOptions`](AgentOptions.md).[`backend`](AgentOptions.md#backend)
...
[`AgentOptions`](AgentOptions.md).[`blockShellFileOps`](AgentOptions.md#blockshellfileops)
...
[`AgentOptions`](AgentOptions.md).[`canUseTool`](AgentOptions.md#canusetool)
...
[`AgentOptions`](AgentOptions.md).[`checkpointer`](AgentOptions.md#checkpointer)
...
[`AgentOptions`](AgentOptions.md).[`contextManager`](AgentOptions.md#contextmanager)
...
Defined in: [packages/agent-sdk/src/types.ts:2290](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/types.ts#L2290)
...
[`AgentOptions`](AgentOptions.md).[`disabledCoreTools`](AgentOptions.md#disabledcoretools)
...
[`AgentOptions`](AgentOptions.md).[`disallowedTools`](AgentOptions.md#disallowedtools)
...
[`AgentOptions`](AgentOptions.md).[`fallbackModel`](AgentOptions.md#fallbackmodel)
...
[`AgentOptions`](AgentOptions.md).[`hooks`](AgentOptions.md#hooks)

***

### inheritHooks?

> `optional` **inheritHooks**: `boolean` \| [`HookEvent`](../type-aliases/HookEvent.md)[]

Defined in: [packages/agent-sdk/src/types.ts:2329](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/types.ts#L2329)
...
[`AgentOptions`](AgentOptions.md).[`maxSteps`](AgentOptions.md#maxsteps)
...
[`AgentOptions`](AgentOptions.md).[`middleware`](AgentOptions.md#middleware)
...
Defined in: [packages/agent-sdk/src/types.ts:2293](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/types.ts#L2293)
...
Defined in: [packages/agent-sdk/src/types.ts:2287](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/types.ts#L2287)
...
[`AgentOptions`](AgentOptions.md).[`permissionMode`](AgentOptions.md#permissionmode)
...
[`AgentOptions`](AgentOptions.md).[`pluginLoading`](AgentOptions.md#pluginloading)
...
[`AgentOptions`](AgentOptions.md).[`plugins`](AgentOptions.md#plugins)
...
[`AgentOptions`](AgentOptions.md).[`preloadPlugins`](AgentOptions.md#preloadplugins)
...
[`AgentOptions`](AgentOptions.md).[`skills`](AgentOptions.md#skills)
...
[`AgentOptions`](AgentOptions.md).[`subagents`](AgentOptions.md#subagents)
...
[`AgentOptions`](AgentOptions.md).[`systemPrompt`](AgentOptions.md#systemprompt)
...
[`AgentOptions`](AgentOptions.md).[`tools`](AgentOptions.md#tools)
...
[`AgentOptions`](AgentOptions.md).[`toolSearch`](AgentOptions.md#toolsearch)
