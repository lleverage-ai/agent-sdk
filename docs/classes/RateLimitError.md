...
[@lleverage-ai/agent-sdk](../index.md) / RateLimitError

# Class: RateLimitError

Defined in: [packages/agent-sdk/src/errors/index.ts:537](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L537)
...
> **new RateLimitError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `limit?`: `number`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `remaining?`: `number`; `retryAfter?`: `number` \| `Date`; \}): `RateLimitError`

Defined in: [packages/agent-sdk/src/errors/index.ts:543](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L543)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `limit?`: `number`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `remaining?`: `number`; `retryAfter?`: `number` \| `Date`; \} |
| `options.cause?` | `Error` |
| `options.limit?` | `number` |
| `options.metadata?` | `Record`&lt;`string`, `unknown`&gt; |
| `options.remaining?` | `number` |
| `options.retryAfter?` | `number` \| `Date` |
...
> `readonly` `optional` **retryAfter**: `number` \| `Date`

Defined in: [packages/agent-sdk/src/errors/index.ts:541](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L541)
