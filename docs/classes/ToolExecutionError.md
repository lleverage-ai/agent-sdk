...
[@lleverage-ai/agent-sdk](../index.md) / ToolExecutionError

# Class: ToolExecutionError

Defined in: [packages/agent-sdk/src/errors/index.ts:271](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L271)
...
> **new ToolExecutionError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `toolInput?`: `unknown`; `toolName`: `string`; \}): `ToolExecutionError`

Defined in: [packages/agent-sdk/src/errors/index.ts:282](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L282)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `toolInput?`: `unknown`; `toolName`: `string`; \} |
| `options.cause?` | `Error` |
...
Defined in: [packages/agent-sdk/src/errors/index.ts:280](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L280)
...
Defined in: [packages/agent-sdk/src/errors/index.ts:275](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L275)
