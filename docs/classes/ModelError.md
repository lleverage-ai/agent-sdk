...
[@lleverage-ai/agent-sdk](../index.md) / ModelError

# Class: ModelError

Defined in: [packages/agent-sdk/src/errors/index.ts:408](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L408)
...
> **new ModelError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `modelId?`: `string`; `statusCode?`: `number`; \}): `ModelError`

Defined in: [packages/agent-sdk/src/errors/index.ts:414](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L414)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `modelId?`: `string`; `statusCode?`: `number`; \} |
| `options.cause?` | `Error` |
...
Defined in: [packages/agent-sdk/src/errors/index.ts:412](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L412)
