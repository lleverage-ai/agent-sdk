...
[@lleverage-ai/agent-sdk](../index.md) / TimeoutError

# Class: TimeoutError

Defined in: [packages/agent-sdk/src/errors/index.ts:493](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L493)
...
> **new TimeoutError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `operation`: `string`; `timeoutMs`: `number`; \}): `TimeoutError`

Defined in: [packages/agent-sdk/src/errors/index.ts:504](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L504)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `operation`: `string`; `timeoutMs`: `number`; \} |
| `options.cause?` | `Error` |
...
Defined in: [packages/agent-sdk/src/errors/index.ts:502](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L502)
...
Defined in: [packages/agent-sdk/src/errors/index.ts:497](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L497)
