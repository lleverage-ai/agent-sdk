...
[@lleverage-ai/agent-sdk](../index.md) / CheckpointError

# Class: CheckpointError

Defined in: [packages/agent-sdk/src/errors/index.ts:639](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L639)
...
> **new CheckpointError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `operation`: `"save"` \| `"load"` \| `"delete"` \| `"list"` \| `"fork"`; `threadId?`: `string`; \}): `CheckpointError`

Defined in: [packages/agent-sdk/src/errors/index.ts:650](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L650)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `operation`: `"save"` \| `"load"` \| `"delete"` \| `"list"` \| `"fork"`; `threadId?`: `string`; \} |
| `options.cause?` | `Error` |
| `options.metadata?` | `Record`&lt;`string`, `unknown`&gt; |
| `options.operation` | `"save"` \| `"load"` \| `"delete"` \| `"list"` \| `"fork"` |
...
Defined in: [packages/agent-sdk/src/errors/index.ts:648](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L648)
...
Defined in: [packages/agent-sdk/src/errors/index.ts:643](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L643)
