...
[@lleverage-ai/agent-sdk](../index.md) / NetworkError

# Class: NetworkError

Defined in: [packages/agent-sdk/src/errors/index.ts:460](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L460)
...
> **new NetworkError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `statusCode?`: `number`; `url?`: `string`; \}): `NetworkError`

Defined in: [packages/agent-sdk/src/errors/index.ts:461](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L461)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `statusCode?`: `number`; `url?`: `string`; \} |
| `options.cause?` | `Error` |
