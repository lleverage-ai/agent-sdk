...
[@lleverage-ai/agent-sdk](../index.md) / AuthenticationError

# Class: AuthenticationError

Defined in: [packages/agent-sdk/src/errors/index.ts:583](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L583)
...
> **new AuthenticationError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; \}): `AuthenticationError`

Defined in: [packages/agent-sdk/src/errors/index.ts:584](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L584)
