...
[@lleverage-ai/agent-sdk](../index.md) / ConfigurationError

# Class: ConfigurationError

Defined in: [packages/agent-sdk/src/errors/index.ts:192](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L192)
...
> **new ConfigurationError**(`message`: `string`, `options`: \{ `actualValue?`: `unknown`; `cause?`: `Error`; `configKey?`: `string`; `expectedType?`: `string`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; \}): `ConfigurationError`

Defined in: [packages/agent-sdk/src/errors/index.ts:193](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L193)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `actualValue?`: `unknown`; `cause?`: `Error`; `configKey?`: `string`; `expectedType?`: `string`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; \} |
| `options.actualValue?` | `unknown` |
| `options.cause?` | `Error` |
