...
[@lleverage-ai/agent-sdk](../index.md) / ContextError

# Class: ContextError

Defined in: [packages/agent-sdk/src/errors/index.ts:725](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L725)
...
> **new ContextError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `currentTokens?`: `number`; `maxTokens?`: `number`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `operation?`: `"compact"` \| `"count"` \| `"summarize"`; \}): `ContextError`

Defined in: [packages/agent-sdk/src/errors/index.ts:726](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L726)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `currentTokens?`: `number`; `maxTokens?`: `number`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `operation?`: `"compact"` \| `"count"` \| `"summarize"`; \} |
| `options.cause?` | `Error` |
| `options.currentTokens?` | `number` |
| `options.maxTokens?` | `number` |
| `options.metadata?` | `Record`&lt;`string`, `unknown`&gt; |
| `options.operation?` | `"compact"` \| `"count"` \| `"summarize"` |
