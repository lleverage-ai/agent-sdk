...
[@lleverage-ai/agent-sdk](../index.md) / SubagentError

# Class: SubagentError

Defined in: [packages/agent-sdk/src/errors/index.ts:759](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L759)
...
> **new SubagentError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `subagentName`: `string`; `task?`: `string`; \}): `SubagentError`

Defined in: [packages/agent-sdk/src/errors/index.ts:770](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L770)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `subagentName`: `string`; `task?`: `string`; \} |
| `options.cause?` | `Error` |
...
Defined in: [packages/agent-sdk/src/errors/index.ts:763](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L763)
...
Defined in: [packages/agent-sdk/src/errors/index.ts:768](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L768)
