...
[@lleverage-ai/agent-sdk](../index.md) / MemoryError

# Class: MemoryError

Defined in: [packages/agent-sdk/src/errors/index.ts:802](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L802)
...
> **new MemoryError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `memoryPath?`: `string`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `operation`: `"read"` \| `"write"` \| `"load"` \| `"delete"` \| `"list"`; \}): `MemoryError`

Defined in: [packages/agent-sdk/src/errors/index.ts:813](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L813)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `memoryPath?`: `string`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `operation`: `"read"` \| `"write"` \| `"load"` \| `"delete"` \| `"list"`; \} |
| `options.cause?` | `Error` |
| `options.memoryPath?` | `string` |
| `options.metadata?` | `Record`&lt;`string`, `unknown`&gt; |
| `options.operation` | `"read"` \| `"write"` \| `"load"` \| `"delete"` \| `"list"` |
...
> `readonly` `optional` **memoryPath**: `string`

Defined in: [packages/agent-sdk/src/errors/index.ts:806](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L806)
...
> `readonly` **operation**: `"read"` \| `"write"` \| `"load"` \| `"delete"` \| `"list"`

Defined in: [packages/agent-sdk/src/errors/index.ts:811](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L811)
