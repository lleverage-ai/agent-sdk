...
[@lleverage-ai/agent-sdk](../index.md) / ToolPermissionDeniedError

# Class: ToolPermissionDeniedError

Defined in: [packages/agent-sdk/src/errors/index.ts:314](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L314)
...
> **new ToolPermissionDeniedError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `reason?`: `string`; `toolInput?`: `unknown`; `toolName`: `string`; \}): `ToolPermissionDeniedError`

Defined in: [packages/agent-sdk/src/errors/index.ts:330](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L330)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `reason?`: `string`; `toolInput?`: `unknown`; `toolName`: `string`; \} |
| `options.cause?` | `Error` |
| `options.metadata?` | `Record`&lt;`string`, `unknown`&gt; |
| `options.reason?` | `string` |
| `options.toolInput?` | `unknown` |
...
Defined in: [packages/agent-sdk/src/errors/index.ts:328](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L328)
...
Defined in: [packages/agent-sdk/src/errors/index.ts:323](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L323)
...
Defined in: [packages/agent-sdk/src/errors/index.ts:318](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L318)
