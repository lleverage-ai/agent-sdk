...
[@lleverage-ai/agent-sdk](../index.md) / ValidationError

# Class: ValidationError

Defined in: [packages/agent-sdk/src/errors/index.ts:224](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L224)
...
> **new ValidationError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `fieldErrors?`: `Record`&lt;`string`, `string`[]&gt;; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; \}): `ValidationError`

Defined in: [packages/agent-sdk/src/errors/index.ts:230](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L230)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `cause?`: `Error`; `fieldErrors?`: `Record`&lt;`string`, `string`[]&gt;; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; \} |
| `options.cause?` | `Error` |
...
Defined in: [packages/agent-sdk/src/errors/index.ts:228](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L228)
...
Defined in: [packages/agent-sdk/src/errors/index.ts:255](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L255)
