...
[@lleverage-ai/agent-sdk](../index.md) / AbortError

# Class: AbortError

Defined in: [packages/agent-sdk/src/errors/index.ts:845](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L845)
...
> **new AbortError**(`message`: `string`, `options`: \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `reason?`: `string`; \}): `AbortError`

Defined in: [packages/agent-sdk/src/errors/index.ts:851](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L851)
...
| `options` | \{ `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `reason?`: `string`; \} | `{}` |
...
Defined in: [packages/agent-sdk/src/errors/index.ts:849](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L849)
