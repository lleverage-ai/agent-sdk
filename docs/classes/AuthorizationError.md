...
[@lleverage-ai/agent-sdk](../index.md) / AuthorizationError

# Class: AuthorizationError

Defined in: [packages/agent-sdk/src/errors/index.ts:608](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L608)
...
> **new AuthorizationError**(`message`: `string`, `options`: \{ `action?`: `string`; `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `resource?`: `string`; \}): `AuthorizationError`

Defined in: [packages/agent-sdk/src/errors/index.ts:609](https://github.com/lleverage-ai/agents/blob/9d15cf28d2e7b406d40c136299754149de055155/packages/agent-sdk/src/errors/index.ts#L609)
...
| :------ | :------ |
| `message` | `string` |
| `options` | \{ `action?`: `string`; `cause?`: `Error`; `metadata?`: `Record`&lt;`string`, `unknown`&gt;; `resource?`: `string`; \} |
